...
<div class="container">
        ...
        <div class="chart-box">
            ...
            <div class="button-container">
              <a href="index.php?action=agregar_partido" class="Register">Agregar</a>
              <button type="button" class="cancel"><a href="index.php?action=agregar_partido" class="Register">Agregar</a></button>
            </div>
            <table>
                <thead>
                    <tr>
