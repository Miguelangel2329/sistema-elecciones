...
<div class="container">
        ...
        <section class="main">
            ...
            <div class="form-container">
                <h3>Registrar un nuevo puesto</h3>
                <form action="index.php?action=guardar_puesto" method="post" enctype="multipart/form-data">
                    ...
                    <div class="checkbox-container">
                        ...
                        <label for="confirmacion">Estas seguro de registrar un nuevo puesto</label>
                    </div>
